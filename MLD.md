...
| ------------------ | ------- | -------- |
| codeMission        | INT     |          |
| titreMission       | VARCHAR | 255      |
| descriptionMission | VARCHAR | 255      |
| dateDébut          | DATE    |          |
| dateFin            | DATE    |          |
...
| ------------------ | ------- | -------- |
| codeTypeMission    | INT     |          |
| libelléTypeMission | VARCHAR | 255      |
...
| ------------------ | ------- | -------- |
| codeTypePlanque    | INT     |          |
| libelléTypePlanque | VARCHAR | 255      |
